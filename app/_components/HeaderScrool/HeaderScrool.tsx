...
const HeaderScroll = () => {
  ...
  return (
    <div
      className={`
        flex flex-row justify-between fixed sm:text-3xl text-lg font-bold shadow-lg sm:w-6xl w-xs z-1 text-gray-500 rounded-4xl px-7 items-center sm:mx-0 mx-4 sm:py-6 py-3 border border-white transition-all duration-300
        ${
          scrolled
